<template>
    <header class="header">
            ...
            <div class="navbar-right-container" style="display: flex;">
                <div class="navbar-menu-container">
                    ...
                    <a href="javascript:void(0)" class="navbar-link" v-if="!nickName"
                       @click="popupVisible=true">Login</a>
      ...
      <mt-popup
        ...
        <mt-field label="userPwd" placeholder="Input userPwd" v-model="userPwd"></mt-field>
        <mt-field label="tel" placeholder="Input tel" v-model="tel"></mt-field>
