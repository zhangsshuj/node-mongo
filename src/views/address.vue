<template>
    <div class="checkout-page">
                ...
                <div class="addr-list-wrap">
                    <div class="addr-list">
                        <ul>
                            ...
                            <li class="addr-new" @click="addAdressFn">
      ...
      <mt-popup
        ...
        <mt-field label="streetName" placeholder="Input streetName" v-model="streetName"></mt-field>
        <mt-field label="postCode" placeholder="Input postCode" type="number" v-model="postCode"></mt-field>
        <mt-field label="tel" placeholder="Input tel" type="tel" v-model="tel"></mt-field>
        <mt-radio
          title="radio list"
          v-model="isDefault"
          :options="['是', '否']">
        </mt-radio>
        <mt-button type="primary" @click="saveAddressFn">primary</mt-button>
        <mt-button type="danger" @click="cancelAddressFn">danger</mt-button>
      </mt-popup>
    </div>
</template>
        ...
        methods: {
          ...
          saveAddressFn() {
            let params = {
              ...
              isDefault: this.isDefault == '是' ? true : false
            }
            this.$http.post('/users/addAddress', params).then((res) => {
